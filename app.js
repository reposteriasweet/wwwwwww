...
function agregarProductoAlCarrito(titulo, precio, imagenSrc) {
    ...
    var nombresProductosCarrito = itemsCarrito.getElementsByClassName('carrito-item-titulo');
    ...
    `;
    item.innerHTML = productoCarritoContenido;
    itemsCarrito.append(item);

    // Agregamos la funcionalidad eliminar al nuevo producto
    item.getElementsByClassName('btn-eliminar')[0].addEventListener('click', eliminarProductoCarrito);

    // Agregamos la funcionalidad restar cantidad del nuevo producto
    var botonRestarCantidad = item.getElementsByClassName('restar-cantidad')[0];
    botonRestarCantidad.addEventListener('click', restarCantidad);

    // Agregamos la funcionalidad sumar cantidad del nuevo producto
...
function eliminarProductoCarrito(event) {
    ...
    // La siguiente función controla si hay productos en el carrito
    // Si no hay elimino el carrito
    ocultarCarrito();
}

// Función que controla si hay productos en el carrito. Si no hay oculto el carrito.
...
function actualizarTotalCarrito() {
    ...
    for (var i = 0; i < carritoItems.length; i++) {
        ...
        // Quitamos el símbolo del sol y el punto de milesimos.
    ...
    // Formato del total en soles con separación de miles
